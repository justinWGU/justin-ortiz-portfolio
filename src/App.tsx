  ...
  return (
    <div className='bg-black'>
      ...
      <section id='intro' className='flex flex-col items-center justify-center h-screen text-white'>
        ...
        <p className='text-sm mt-4 tracking-[0.3em] uppercase'>Fullstack Software Engineer</p>
        <nav className='flex gap-8 mt-10 text-gray-300 hover:text-white hover:cursor-pointer transition'>
      ...
      <section id='projects' className='min-h-screen max-w-3xl mx-auto px-6 py-24 gap-4 flex flex-col'>
        <h2 className='text-sm uppercase tracking-widest text-gray-400'>Projects</h2>
          ...
          <div className='flex flex-col gap-2 p-6 border border-white/10 bg-white/5 rounded-xl transition hover:bg-white/10'>
              ...
              <p className='text-gray-200'>Developed and deployed a full stack web app to display real-time Call of Duty scores. Used OpenCV to extract scores from live stream frames and an LLM API to convert data to structured output for a Django REST API.</p>
          ...
          <div className='flex flex-col p-6 gap-2 border border-white/10 bg-white/5 rounded-xl transition hover:bg-white/10'>
              ...
              <p className='text-gray-200'>Built a web app for manual and autonomous robot control. Backend runs on a Raspberry Pi using Django, OpenCV, and a local LLM to generate movement commands sent via UART to an STM32 microcontroller. </p> 
              <div className='flex gap-2 text-gray-400'>
                <p>React •</p>                
                <p>Django •</p>
                <p>C •</p>
          ...
          <div className='flex flex-col p-6 border gap-2 border-white/10 bg-white/5 rounded-xl transition hover:bg-white/10'>
              ...
              <p className='text-gray-200'>Enhanced an app with multi-threading, timezone messaging, and real-time currency exchange.</p>
              <div className='flex gap-2 text-gray-400'>
                <p>Spring Boot •</p>                
                <p>Angular •</p>           
                <p>Docker</p>
      ...
      <section id='about' className='flex flex-col gap-4 max-w-3xl mx-auto px-12 py-24'>
        ...
        <p className='max-w-lg text-gray-300'>I create intelligent full-stack web apps that integrate AI like LLMs and computer vision. I also bring embedded systems expertise, connecting these advanced technologies with hardware to create innovative solutions.</p>
      </section>
      ...
      <section id='contact' className='flex flex-col gap-4 mx-auto max-w-3xl px-12 py-24'>
        ...
        <p className='text-gray-300'>Interested in working together or just want to say hello?</p>
